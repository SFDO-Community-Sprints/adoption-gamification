...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>PlusOne</application>
    ...
    <fieldPermissions>
        <editable>false</editable>
        <field>Reward_Assignment__c.Points_Needed__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>false</editable>
        <field>Reward_Assignment__c.Points_to_Award__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>Reward_Assignment__c.Reward_To__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <layoutAssignments>
        <layout>Reward_Assignment__c-Reward Assignment Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
    ...
    <objectPermissions>
        ...
        <allowRead>true</allowRead>
        <modifyAllRecords>true</modifyAllRecords>
        <object>Reward_Assignment__c</object>
        <viewAllRecords>true</viewAllRecords>
    </objectPermissions>
    <objectPermissions>
        <allowCreate>true</allowCreate>
